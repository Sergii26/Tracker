...
public class AuthPresenterLoginModeTest {

    private final int mode = FragmentIndication.LOGIN_MODE;
    ...
    public void setupSubscription_withValidLoginAndPassword(){
        ...
        Mockito.verify(view).getString(R.string.label_login);
